...
public readonly record struct CircleCollider(int X, int Y, int Radius)
{
    ...
    private static readonly CircleCollider s_empty = new CircleCollider();
    public static CircleCollider Empty => s_empty;
    public CircleCollider(Point location, int radius) : this(location.X, location.Y, radius) { }

    public bool ClampWithin(Rectangle rectangle)
    {
